...
deploy:
	-@git add . && git subtree push --prefix=html git@github.com:zacjszewczyk/zacjszewczyk.github.io.git master 2> /dev/null || echo `date`": Unable to push to GitHub Pages repo."
