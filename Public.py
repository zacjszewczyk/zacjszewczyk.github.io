...
def GenExFiles(v=False):
    ...
    utime(dst+"Content/Test Original Article.txt", ((mktime(strptime("2019/01/02 12:34:56", "%Y/%m/%d %H:%M:%S"))), (mktime(strptime("2019/01/02 12:34:56", "%Y/%m/%d %H:%M:%S")))))
    utime(dst+"Content/Test Linkpost.txt", ((mktime(strptime("2019/01/01 12:34:56", "%Y/%m/%d %H:%M:%S"))), (mktime(strptime("2019/01/01 12:34:56", "%Y/%m/%d %H:%M:%S")))))
